namespace NUnit.Result.Writer.V2.Utils
{
    using System.Linq;
    using System.Xml;
    ...
    {
        internal static XDocument GetXDocument(this XmlDocument document)
        {
        ...
        internal static XmlDocument GetXmlDocument(this XDocument document)
        {
